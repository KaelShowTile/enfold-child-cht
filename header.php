...
<div id="cht-cart-sidebar">

 	<div class="cht-sidebar-header">
		<h3>Shopping Cart</h3>
		<span class="cht-sidebar-close">&times; <p>Close</p></span>
	</div>
    
    <div class="cht-sidebar-content">

		<div class="tab-content" id="cht-sidebar-cart-tab-content">

			<div class="tab-panel fade show active" id="cht-min-cart" role="tabpanel" aria-labelledby="cht-min-cart-tab">
				<div class="widget_shopping_cart_content cht-min-cart-inner">
					<?php woocommerce_mini_cart(); ?>
				</div>
				<div id="reach-bottom-of-cart"></div>
			</div>
