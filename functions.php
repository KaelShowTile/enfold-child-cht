...
add_filter('woocommerce_gateway_title', 'change_stripe_gateway_title', 10, 2);
function change_stripe_gateway_title($title, $id) {
    if ($id === 'stripe') {
        return __('Credit Cards', 'your-text-domain');
    }
    return $title;
}