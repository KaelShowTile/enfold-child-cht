	...
	<div class = "add-to-wishlist-container">
		...
		<div class="cht-product-tags">
			<ul>
				...
				$attribute_origin = get_the_terms($get_product_id, 'pa_origin');

				if($attribute_origin){
					echo '<li>';
					echo '<a class="parent-categories-item">Origin: </a>';
					echo '<p>';
					
					foreach($attribute_origin as $origin){
						echo '<a class="child-categories-item"> ' . $origin->name . ' </a>';
					}
					echo '</p></li>';
				}
